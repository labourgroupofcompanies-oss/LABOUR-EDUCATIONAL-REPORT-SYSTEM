...
const HeadteacherGuideWidget = () => {
  ...
  const steps = [
    {
      id: 1,
      title: '1. Academic Calendar & Term',
      route: '/setup',
      isComplete: step1Complete,
      isUnlocked: true,
      prerequisites: 'None',
      shortDesc: 'Configure active Academic Year and Term (Term 1, 2, or 3).',
      details: 'Everything in the app relies on having an active academic year and term configured first.',
    ...
    },
    {
      ...
      prerequisites: 'Step 1 (Academic Calendar)',
      shortDesc: 'Create school classes and assign subjects to each class.',
      details: 'Classes and subjects must exist before teachers or learners can be assigned.',
    ...
    },
    {
      ...
      details: 'Teachers need active accounts and class/subject assignments to enter student scores.',
      icon: 'fa-user-tie',
      color: '#a78bfa',
    },
    {
      id: 4,
      title: '4. Learner Enrollment',
      route: '/learners',
      isComplete: step4Complete,
      isUnlocked: step2Complete,
      prerequisites: 'Step 2 (Classes)',
      shortDesc: 'Add or bulk-import learners into designated classes.',
      details: 'Register student details and assign them to their current class.',
      icon: 'fa-user-graduate',
      color: '#34d399',
    },
    {
      id: 5,
      title: '5. Score Entry & Broadsheet',
      route: '/scores',
      isComplete: step5Complete,
      isUnlocked: step3Complete && step4Complete,
      prerequisites: 'Step 3 (Teachers) & Step 4 (Learners)',
      shortDesc: 'Teachers enter scores; Headteacher reviews Broadsheet.',
      details: 'Teachers record Continuous Assessment (CA) and Exams. Review overall performance in Broadsheet.',
      icon: 'fa-pen-to-square',
      color: '#fbbf24',
    },
    {
      id: 6,
      title: '6. School Wallet & Subscription',
      route: '/financials',
      isComplete: step6Complete,
      isUnlocked: step4Complete,
      prerequisites: 'Step 4 (Enrolled Learners)',
      shortDesc: 'Check wallet balance or enjoy your Free First Term.',
      details: 'Newly registered schools get First Term Free! Top up wallet for next term to keep report cards unlocked.',
      icon: 'fa-wallet',
      color: '#ec4899',
    },
    {
      id: 7,
      title: '7. Report Cards & Parent Release',
      route: '/reports',
      isComplete: step7Complete,
      isUnlocked: step5Complete && step6Complete,
      prerequisites: 'Step 5 (Scores Completed) & Step 6 (Wallet Active)',
      shortDesc: 'Compile report cards, add Headteacher remarks, and Release to Parents.',
      details: 'Generate official termly report cards and click Release Reports for parents to access via Parent Portal.',
