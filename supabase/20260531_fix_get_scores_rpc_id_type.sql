-- Migration: Fix get_scores_by_guardian_contact RPC Return Type (BIGINT to UUID)
-- Date: 2026-05-31

-- 1. Drop existing function to allow changing return types
DROP FUNCTION IF EXISTS public.get_scores_by_guardian_contact(TEXT);

-- 2. Re-create the function with the corrected id UUID column type
